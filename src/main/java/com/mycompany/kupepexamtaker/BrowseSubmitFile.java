...
public class BrowseSubmitFile extends javax.swing.JFrame {
 
    /**
     * Creates new form ContactEditor
     */
    ExamTaker examTakerForm;
    public BrowseSubmitFile(ExamTaker examTakerForm ) {
        this.examTakerForm = examTakerForm ;
        initComponents();
